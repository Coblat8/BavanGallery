			...
			<AnimatePresence>
				{currentPainting !== 0 &&
					<motion.div
						...
						key={currentPainting}
						id="html-container"
						className='fixed top-[65vh] lg:top-1/2 lg:-translate-y-1/2 left-1/2 lg:right-40 bg-neutral-200/30 lg:bg-neutral-500/20 backdrop-blur-lg flex flex-col shrink-0 items-start justify-start gap-4 w-full h-[30vh] lg:w-[34rem] lg:h-[36rem] rounded-2xl shadow-lg drop-shadow-lg z-50 '>
						<div className=" flex flex-col gap-2 lg:gap-4 pt-4 lg:pt-16">
							...
							<span className=" text-xs lg:text-base font-outfit text-neutral-900/70 pt-2 lg:py-6 px-16"> untitiled, Sepideh Farzam, 2025</span>
						</div>
